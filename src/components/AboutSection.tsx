          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <Card className="card-hover">
              <CardContent className="pt-6">
                <div className="mb-4 bg-portfolio-light-purple/30 w-12 h-12 rounded-full flex items-center justify-center">
            ...
            <Card className="card-hover">
              <CardContent className="pt-6">
                <div className="mb-4 bg-portfolio-light-purple/30 w-12 h-12 rounded-full flex items-center justify-center">
                  <LucideGraduationCap className="text-portfolio-purple" />
                </div>
            ...
            <Card className="card-hover sm:col-span-2">
              <CardContent className="pt-6">
                <div className="mb-4 bg-portfolio-light-purple/30 w-12 h-12 rounded-full flex items-center justify-center">
                  <Coffee className="text-portfolio-purple" />
                </div>
