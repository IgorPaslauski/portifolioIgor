...
const experiences = [
  {
    ...
    description:
      "Liderança na criação de aplicações web responsivas e de alta performance utilizando React e TypeScript. Implementação de testes automatizados e otimização de performance.",
    achievements: [
  ...
  },
  {
    ...
    description:
      "Desenvolvimento de aplicações web completas, atuando tanto no frontend quanto no backend. Construção de APIs RESTful e integração com serviços de terceiros.",
    achievements: [
  ...
  },
  {
    ...
    description:
      "Desenvolvimento de websites e landing pages para diversos clientes, com foco em design responsivo e otimização para mecanismos de busca.",
    achievements: [
