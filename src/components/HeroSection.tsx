      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 md:pr-12">
            <p className="text-portfolio-purple font-semibold mb-4">
              Desenvolvedora Full Stack
            </p>
            <h1 className="mb-6">
              Olá, eu sou <span className="gradient-text">Ígor Paslauski Pedroso de Oliveira</span>
            </h1>
            <p className="text-lg text-gray-700 mb-8 max-w-xl">
              Transformando ideias em experiências digitais intuitivas através
              de código limpo e design moderno. Especializada em desenvolvimento
              front-end e back-end com foco em React, Node.js e TypeScript.
            </p>
            ...
            <div className="flex mt-8 space-x-4">
              <Button variant="ghost" size="icon" className="rounded-full" onClick={() => window.open("https://github.com/IgorPaslauski", "_blank")}>
